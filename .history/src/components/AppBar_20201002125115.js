            ...
            <AppBar style={appbar} position="static">
                <Toolbar style={header}>
                    ...
                    <Menu id="menu-appbar" anchorEl={currentTarget} anchorOrigin={{ vertical: 'top', horizontal: 'right' }}
                        keepMounted transformOrigin={{ vertical: 'top', horizontal: 'right' }} open={openMenu} >
                    ...
                    <Menu id="menu-appbar" anchorEl={currentTarget} anchorOrigin={{ vertical: 'top', horizontal: 'right' }}
                        keepMounted transformOrigin={{ vertical: 'top', horizontal: 'right' }} open={openSession} >
                        <MenuItem value="Logout" style={{ justifyContent: 'center' }} >df</MenuItem>
