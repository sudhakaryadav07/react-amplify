...
class Home extends Component {
    ...
    renderUser() {
        ...
        return users.map((data, i) => {
            let mt = i === 0 ? '2%' : 0;
            return (
                // <Card key={i} onClick={() => this.props.history.push('/blog')} style={{ ...userCard, position: "relative", margin: `${mt} 0px 2% 0px`, }}>
            ...
            <Fragment>
                ...
                <section className={classes.section1}>
                    <img
                        ...
                        height="600"
                    />
                    <Typography color="textSecondary" style={{ position: 'absolute', top: '30%', left: '50%', fontFamily: 'Forte', fontSize: 33, color: 'white' }}>
                        {message ? message : ""}
                    </Typography>
                </section>
                <section className={classes.root}>
                    <Container className={classes.container}>
                        ...
                        <Grid container sm={12} spacing={2} style={{ display: 'flex', justifyContent: 'flex-end' }}>
                            <TextField
                                style={{ width: '20%' }}
                                size="small"
                                name="searchInput"
