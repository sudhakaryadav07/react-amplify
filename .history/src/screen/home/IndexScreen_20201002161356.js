...
class Home extends Component {
    ...
    renderUser() {
        ...
        return users.map((data, i) => {
            let mt = i === 0 ? '2%' : 0;
            return (
                <Card key={i} style={{cursor:"pointer", height: 140, margin: `${mt} 0px 2% 0px`, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Grid container sm={12} style={{ height: '100%' }}>
                        <Grid item container item sm={4} style={{ height: '100%',backgroundColor:'#f5f5dc' }}>
