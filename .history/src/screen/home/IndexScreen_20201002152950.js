...
import { progress, root, body, bodyContext } from '../../styles/style';
...
class Home extends Component {
    ...
    renderUser() {
        ...
        return users.map((data, i) => {
            return (
                <Card key={i} style={{ backgroundColor: 'red', height: 100, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>{data.name}</Card>
            );
        })
    }
            ...
            <div style={root}>
                ...
                <div style={body}>
                    <div style={bodyContext}>
                        ...
                        <div style={{ height: '10vh', padding: '0px 20%' }}>
                            <TextField
                                fullWidth
                                name="searchInput"
                                value={searchInput}
                        ...
                        <div style={{ height: '70vh',backgroundColor:'red' ,padding:10 }}>
                            <div style={{ height: '100vh', overflow: 'auto',backgroundColor:'green' }}>
                                    dasd   {/* {this.renderUser()} */}
                            </div>
                        </div>
                    </div>
                </div>
