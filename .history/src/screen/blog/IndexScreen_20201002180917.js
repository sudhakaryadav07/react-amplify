                    ...
                    <div style={{ ...bodyContext, paddingTop: 10, paddingBottom: 10 }}>
                        <Grid sm={12} spacing={2} style={{ margin: 0 }}>
                            ...
                            <Grid container sm={12} spacing={2} style={{ margin: 0, padding: 6, height: 230 }}>
                                <Grid item sm={4}>
                                    <Paper style={{height:'100%' }}>
                                        <div style={{ height: '20%',borderTopLeftRadius:5,borderTopRightRadius:5, backgroundColor: '#888' }}>
                                        ...
                                        <div style={{ height: '80%',padding:'5px 5px 0px 5px' }}>
                                            <Typography color="textSecondary" style={{ height: 160, overflow: 'auto', fontFamily: 'system-ui', fontSize: 15, color: 'black' }}>
                                                {USER[0].about}
                                            </Typography>
                                        </div>
                                    </Paper>
                                ...
                                <Grid item sm={4} >
                                    <Paper style={{ padding: 5 }}>
                                        <Typography color="textSecondary" style={{ height: 180, overflow: 'auto', fontFamily: 'system-ui', fontSize: 15, color: 'black' }}>
                                            {USER[0].about}
                                        </Typography>
                                    </Paper>
                                </Grid>
